...
Maturity assessment: this resource is a reproducible educational prototype; general-purpose deployment and sparse-kernel savings remain untested here. BDH-CQ is a later recurrent latent reasoning system; this artifact neither implements nor evaluates it. [4] **Not an official BDH model.** Claude and Codex assisted this work. Editable sources, notices, and reproduction commands accompany the PDFs.
